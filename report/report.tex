...
states) or dispersive (The frequencies and the gap do not match).
...
\subsection{Rydberg Ciruclar atoms}\label{ssec:atoms}
...
\begin{rem}
  ...
  superposition while
  a statistical mixture would be
  $50$ \% of $\ket 0$ and $50$\% of $\ket 1$. When the state in measured in base
  $\ket0,\ket1$, the results will be the same but in an other base they could be
